...
<br>
### <h2>Colors</h2>
> <h3>Blue Text</h3> = ``` <h3 class="blue">Blue Text</h3> ```<br>
> <h3>Red Text</h3> = ``` <h3 class="red">Red Text</h3> ```<br>
> <h3>Yellow Text</h3> = ``` <h3 class="yellow">Yellow Text</h3> ```<br>
> <h3>White Text</h3> = ``` <h3 class="white">White Text</h3> ```<br>
> <h3>Green Text</h3> = ``` <h3 class="green">Green Text</h3> ```<br>
> <h3>Light Green Text</h3> = ``` <h3 class="light-green">Light Green Text</h3> ```<br>
